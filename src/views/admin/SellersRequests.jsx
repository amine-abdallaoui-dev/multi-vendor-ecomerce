            ...
            <div className="w-[95%] mx-5 bg-[#edf5f5] p-5 mt-[30px] h-auto  mb-[20px]">
                <table className="w-full overflow-x-scroll sm:overflow-x-scroll  md:overflow-x-scroll lg:overflow-x-hidden">
                    <tr className="text-[13px] lg:text-sm font-medium border-b border-gray-600">
                        ...
                        <td className="w-[12%] lg:w-[8%] text-gray-900">Payment status </td>
                        ...
                        [1,2,3,4,5].map((item, index) => {
                            return (
                                <tr className="text-[13px] lg:text-sm font-[400] w-full hover:bg-white">
                                    ...
                                    <td className="w-[12%] lg:w-[8%] text-gray-900">Active</td>
                                    <td className="lg:w-[8%] text-gray-900">Active</td>
                                    <td className="lg:w-[10%] text-gray-900 flex justify-center items-center gap-2 pt-3">
                                        <span><Link className="px-2 py-2 w-[35px] h-[35px]  rounded-md bg-blue-500 hover:blue-red-400 text-white  flex items-center justify-center"><FaRegEye  /></Link></span>
                                        <span><Link className="px-2 py-2 w-[35px] h-[35px]  rounded-md bg-green-600 hover:shadow-green-400 text-white  flex items-center justify-center"><IoCheckmarkDoneSharp  /></Link></span>
                                    </td>
                                </tr>
                            )
                        })
